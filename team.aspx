<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="team.aspx.cs" Inherits="project1.team" MasterPageFile="~/Site.Master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <section id="team" class="hero" style="padding-bottom: 0.5rem;">
            <div class="hero-content">
                    ...
                    <span style="animation-delay: 0.25s;">T</span>
                    <span style="animation-delay: 0.3s;">e</span>
                    <span style="animation-delay: 0.35s;">a</span>
                    <span style="animation-delay: 0.4s;">m</span>
                </h1>
